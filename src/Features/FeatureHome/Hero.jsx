  ...
  return (
    <>
      <div
        ...
        className={`pt-[14rem] pb-[9rem] max-md:pt-[9rem] px-[20rem] w-full h-full relative object-cover max-xl:px-[5rem] max-md:px-[2rem] ${
      ...
      >
        ...
        >
          ...
          >
            ...
            <h1
              className={`text-[5rem] max-xl:text-[4rem] max-md:text-[3.5rem] font-cinzel ${
                darkMode ? "text-[cyan]" : "text-[var(--text-primary)]"
              }`}
            >{`I'm Harshvardhan Sharma`}</h1>
            <h2>
              <span
                className={`auto-type text-[3rem] max-md:text-[2.8rem] font-medium ${
          ...
          <div
            ...
            ${darkMode?"border-[cyan]":"border-[var(--bg-secondary)]"} px-[1rem] py-[1rem] transform transition-all duration-[2s] ${
              animate["hero"]
